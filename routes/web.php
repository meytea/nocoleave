...
Route::middleware(['auth', 'role:lead'])->group(function () {
    ...
    Route::get('/lead/pengajuan-cuti/disetujui', [LeadPengajuanCutiController::class, 'pengajuanDisetujui'])->name('lead.pengajuan_cuti.disetujui');
    Route::get('/lead/pengajuan-cuti/ditolak', [LeadPengajuanCutiController::class, 'pengajuanDitolak'])->name('lead.pengajuan_cuti.ditolak');
...
Route::middleware(['auth', 'role:head'])->group(function () {
    ...
    Route::resource('/head/karyawan', HeadController::class)->names('head.karyawan');
