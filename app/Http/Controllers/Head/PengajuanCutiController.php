...
class PengajuanCutiController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('head.pengajuan_cuti.create', compact('jenisCuti', 'hakCuti'));
    }
    ...
    public function pengajuanDisetujui(Request $request)
    {
        ...
        return view(
            'head.pengajuan_cuti.disetujui',
            compact('pengajuanCuti', 'jenisCutiList')
        );
    }
