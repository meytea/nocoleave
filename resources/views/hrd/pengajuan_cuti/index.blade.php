    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <form action="{{ route('hrd.pengajuan_cuti.index') }}" method="GET" class="flex items-center gap-2">
                ...
                <a href="{{ route('hrd.pengajuan_cuti.create') }}"
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm ite">
                            <div class="flex justify-center items-center gap-2">
                                ...
                                <a href="{{ route('hrd.pengajuan_cuti.show', $item->id) }}"
                                    class="bg-blue-100 text-blue-700 px-3 py-2 rounded-lg text-xs font-semibold">
                                    Detail
                                </a>

                                @if($item->status == 'pending_direktur')

                                <a href="{{ route('hrd.pengajuan_cuti.edit', $item->id) }}"
                                    class="bg-yellow-100 text-yellow-700 px-3 py-2 rounded-lg text-xs">
                                    Edit
                                </a>

                                <form action="{{ route('hrd.pengajuan_cuti.destroy', $item->id) }}"
                                    method="POST"
