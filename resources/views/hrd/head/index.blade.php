    ...
    <div class="flex items-center justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-gray-500">
                Kelola penugasan Head pada setiap divisi.
            </p>
        </div>

        <a href="{{ route('head.create') }}"
