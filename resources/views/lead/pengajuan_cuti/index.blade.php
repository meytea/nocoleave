    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <form action="{{ route('lead.pengajuan_cuti.index') }}" method="GET" class="flex items-center gap-2">
                ...
                <a href="{{ route('lead.pengajuan_cuti.create') }}"
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm ite">
                            <div class="flex justify-center items-center gap-2">
                                ...
                                <a href="{{ route('lead.pengajuan_cuti.edit', $item->id) }}"
                                    class="bg-yellow-100 text-yellow-700 px-3 py-2 rounded-lg text-xs">
                                    Edit
                                </a>

                                <form action="{{ route('lead.pengajuan_cuti.destroy', $item->id) }}"
                                    method="POST"
