    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            ...
            {{-- Form Filter Jenis Cuti --}}
                <form action="{{ route('lead.pengajuan_cuti.disetujui') }}" method="GET" class="flex items-center gap-2">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex items-center justify-center gap-3">
                                <a href="{{ route('lead.pengajuan_cuti.show', $item->id) }}"
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <p class="text-gray-600 font-medium">Belum ada pengajuan cuti yang disetujui</p>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="p-12 text-center">
            <div class="flex flex-col items-center gap-3">
                ...
                <div>
                    <p class="text-gray-900 font-bold text-lg">Belum ada pengajuan cuti yang disetujui</p>
                </div>
            </div>
        </div>
        @endif
