...
<div class="space-y-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">
            Selamat datang di Dashboard Head.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <a href="{{ route('head.approval_cuti.disetujui', ['status' => 'sedang_cuti']) }}"
                class="block bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition">
                <div class="flex items-center justify-between">
                    <div>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <form action="{{ route('head.approval_cuti.setuju', $item->id) }}"
                                    method="POST">
                                    @csrf
...
<script>
    ...
    function openRejectModal(id) {
        ...
        form.action =
            "{{ url('/head/approval_cuti') }}/" + id + "/tolak";
